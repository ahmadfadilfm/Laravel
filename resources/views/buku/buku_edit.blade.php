                ...
                <form role="form" method="post" action="{{ url('master/buku/'.$dt->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <label for="exampleInputEmail1">Penulis Buku</label>
                            <input type="text" name="penulis" value="{{ $dt->penulis }}" class="form-control" id="exampleInputEmail1" placeholder="Penulis Buku">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Tahun Terbit</label>
                            <input type="text" name="tahun_terbit" value="{{ $dt->tahun_terbit }}" class="form-control" id="exampleInputEmail1" placeholder="Tahun Terbit">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Stock Buku</label>
                            <input type="number" name="stok" value="{{ $dt->stok }}" class="form-control" id="exampleInputEmail1" placeholder="Stock Buku">
                        </div>
